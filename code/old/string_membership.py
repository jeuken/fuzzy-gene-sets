...
def process_and_expand_pathways(gmt_path, Ensembl_ID_dict_path, string_scores_path, output_file):
    ...
    try:
        ...
        final_df = pathways_expanded.fillna({'Default_Membership': 0, 'Overlap_Membership': 0})
        ...
        print(f"Maximum value in 'Expansion_Membership' (below 1): {filtered_df['Expansion_Membership'].max()}")
        print(f"Minimum value in 'Expansion_Membership' (below 1): {filtered_df['Expansion_Membership'].min()}")
...
results = process_and_expand_pathways(gmt_path, Ensembl_ID_dict_path, string_scores_path, output_file)
print(results)
