...
null_distribution_path = '../../data/bias_under_null/null_distributions_crisp_local_reaching.csv'  # Path to the null distribution data
results = pd.read_csv(null_distribution_path, sep='\t', index_col=0)  # Load the data, using the first column as the index

# Ensure the output directory exists before saving
output_dir_hist = '../../data/bias_under_null/null_distributions/histograms_crisp_local_reaching/'  # Path to save the histograms
os.makedirs(output_dir_hist, exist_ok=True)  # Create the directory if it does not exist

# Ensure the output directory exists before saving
output_dir_cdf = '../../data/bias_under_null/null_distributions/cdf_crisp_local_reaching/'  # Path to save the histograms
os.makedirs(output_dir_hist, exist_ok=True)  # C

# Ensure the output directories exist before saving
output_dir_pathway_hist = '../../data/bias_under_null/null_distributions/histograms_crisp_local_reaching/'  # Path to save the histograms
output_dir_pathway_cdf = '../../data/bias_under_null/null_distributions/cdf_crisp_local_reaching/'  # Path to save the CDFs
