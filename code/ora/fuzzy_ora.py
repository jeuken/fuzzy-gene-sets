...
def fuzzy_ora(query_file, pathway_file, specific_pathway=None, 
              ...
              output_file='ora_enrichment_scores.csv', iterations=1000, plot_path='null_distributions'):
    """
    ...
    Args:
        ...
        plot_path (str, optional): Directory to save the histogram plots of null distributions.
...
# Application
query_file = "/Users/piamozdzanowski/VU/Fuzzy_Gene_Sets/data/gemma/Huntingtons_GSE64810_query_t.csv"
...
output_file = "/Users/piamozdzanowski/VU/Fuzzy_Gene_Sets/data/ORA_output/Huntingtons_GSE64810/ora_scores.csv"
plot_path = "/Users/piamozdzanowski/VU/Fuzzy_Gene_Sets/data/ORA_output/Huntingtons_GSE64810/null_distributions"
...
fuzzy_ora(query_file, pathway_file, query_membership_type=query_membership_type, 
          ...
          iterations=100000, plot_path=plot_path)
