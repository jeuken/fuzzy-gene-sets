...
if __name__ == "__main__":
    ...
    pathway_file = '../../../data/pathways/KEGG/KEGG_2022_parsed_ensembl.tsv'
    output_path = '../../../data/pathways/KEGG/'
    string_path = '../../../data/pathways/STRING/STRING_GGI.txt'
    topology_path = '../../../data/pathways/KEGG/topology/kegg_centrality_results_ensembl.tsv'
    membership_types = ["crisp", "overlap", "topology"]
    #
    pathway_df = pathway_memberships(
